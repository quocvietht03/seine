...
class Widget_PricingItem extends Widget_Base
{
	...
	protected function register_style_box_section_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bt-pricing--contentinfo' => 'border-radius: 0 0 {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .bt-elwg-pricing-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'box_shadow',
				'selector' => '{{WRAPPER}} .bt-elwg-pricing-item',
			]
		);
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bt-pricing--contentfeatured' => 'background: {{VALUE}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bt-pricing--priceafter' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .bt-pricing--priceafter',
			]
		);
		$this->add_control(
			'time_pricing',
		...
		$this->add_control(
			...
			[
				...
				'default' => '#f7f4ef',
				'selectors' => [
					'{{WRAPPER}} .bt-pricing--contentinfo' => 'background: {{VALUE}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bt-pricing--listinfo li' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .bt-pricing--listinfo li',
			]
		);
		$this->add_responsive_control(
			'info_ratio',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bt-pricing--listinfo ' => 'margin-bottom: {{SIZE}}px;',
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bt-pricing--buttonmore a' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .bt-pricing--buttonmore',
			]
		);
...
?>
		<div class="bt-elwg-pricing-item">
			<div class="bt-pricing-item">
				<div class="bt-pricing--featured">
					...
					<?php } ?>
					<div class="bt-pricing--contentfeatured">
						<?php
						if (!empty($settings['heading'])) {
							echo '<h3 class="bt-pricing--heading">' . $settings['heading'] . '</h3>';
						}
						?>
						<div class="bt-pricing--pricetime">
							<div class="bt-pricing--price">
								...
								if (!empty($settings['price_after'])) {
									echo '<span class="bt-pricing--priceafter">' . $settings['price_after'] . '</span>';
								}
								?>
							</div>
				...
				<div class="bt-pricing--contentinfo">
					<?php if (!empty($settings['list_info'])) { ?>
						<ul class="bt-pricing--listinfo">
					...
					echo '<div class="bt-pricing--boxbutton">';
					...
					if (!empty($settings['button_more'])) {
						echo '<div class="bt-pricing--buttonmore">or <a ' . $this->get_render_attribute_string('button_more_url') . ' >' . $settings['button_more'] . '</a></div>';
					}
					echo '</div>';
					?>
				</div>
