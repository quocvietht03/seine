...
<div id="Import_Pack_Container">
    ...
    <h1 class="heading-page"><?php echo apply_filters( 'seine/import_pack/heading_text', __( 'Seine Import Package Demo.', 'seine' ) ); ?></h1>

    <?php do_action( 'seine/import_pack/before' ); ?>
    ...
    <div class="ip-footer">
        <?php echo apply_filters( 'seine/import_pack/footer_text', __( 'Power by Beplus, Thank you creating with Seine.', 'seine' ) ); ?>
    </div>

    <?php do_action( 'seine/import_pack/after' ); ?>
...
<div id="Import_Pack_Modal" class="ip-modal-container">
    <div class="ip-modal">
        <div class="ip-modal-header">
            <a href="javascript:" class="__close" title="<?php echo esc_attr( 'close', 'seine' ); ?>">
